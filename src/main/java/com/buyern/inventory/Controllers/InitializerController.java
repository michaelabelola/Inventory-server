...
import com.buyern.inventory.Repositories.UserAuthRepository;
...
final UserAuthRepository userAuthRepository;
    @GetMapping("init1")
    private UserAuth init() {
        EntityPermission entityPermission = EntityPermission.builder().entityId("entityId1")
                .tools(
                        List.of(ToolPermission.builder()
                                .tool("Inventories")
                                .main(
                                        Map.of("read", "true")
                                ).build())
        ...
        userAuth.setEntities(List.of(entityPermission));
